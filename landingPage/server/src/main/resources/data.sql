...
insert ignore into data (id, email, timestamp, answer_2, answer_3)
values ('2947c292-fb1f-4157-817c-0f533c14a278', 'test1@abv.bg', '2021-10-21T05:47:08.644', '0','test1'),
       ('8fc49611-18c8-4e9a-b666-bc9015a0e71b', 'test2@abv.bg', '2021-10-21T05:47:08.644', '1','test2'),
       ('b5c29689-f5a1-44c5-bad2-09afdd9a51ef', 'test3@abv.bg', '2021-10-21T05:47:08.644', '2','test3'),
       ('1137e39e-cdc6-4160-849f-bfa5506e7ba4', 'test4@abv.bg', '2021-10-21T05:47:08.644', '3','test4'),
       ('318ee786-4f1c-430a-8ac4-17f0393a38f1', 'test5@abv.bg', '2021-10-21T05:47:08.644', '4','test5');


insert ignore into question_1_answers(id, value, data_id)
...
insert ignore into text_input_1(value, data_id)
values ('TEST_INPUT_1','1137e39e-cdc6-4160-849f-bfa5506e7ba4');
insert ignore into text_input_2(value, data_id)
