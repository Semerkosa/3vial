...
public class ApiURLs {
    ...
    public static final String GET_ALL_BANKS_FOR_COUNTRY_URL = "https://ob.nordigen.com/api/aspsps/?country=";
    ...
    public static final String ACCOUNT_URL = "http://localhost:8086/api/accounts/";
}
